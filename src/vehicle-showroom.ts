...
controls.minDistance = 3; controls.maxDistance = 16; controls.maxPolarAngle = Math.PI * .49;
...
function resize() {
  ...
  camera.fov = THREE.MathUtils.radToDeg(2 * Math.atan(Math.tan(THREE.MathUtils.degToRad(18)) * Math.max(1, 1.45 / camera.aspect)));
