...
async function init() {
  ...
  void loadWebAsset('/assets/models/environment/LM_ENV_MamakMaju.glb?v=mamak-v7', scene, new THREE.Vector3(-29, 0, 30), 'LM_ENV_MamakMaju')
    .then(asset => {
  ...
  let soundRange = 1;
  try {
    const savedRange = Number(localStorage.getItem('lepakmamak-sound-range'));
