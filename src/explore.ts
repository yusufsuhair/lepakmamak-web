...
export const EXPLORE_TUTORIALS = [
  {id:'afk',number:'01',signal:'AFK',title:'Leave an AFK note',description:'Let the city know you stepped away without disappearing.',steps:['Open Settings with Esc or the gear button.','Write a short message under Note.','Choose Set note. Clear it when you are back.']},
  {id:'dance',number:'02',signal:'10s',title:'Start a dance',description:'Drop a ten-second dance wherever the mood finds you.',steps:['Right-click your own character.','On mobile, press and hold your character.','Choose Dance · 10s. Open the menu again to stop.']},
  {id:'friend',number:'03',signal:'+1',title:'Add someone as a friend',description:'Keep the people you meet around for the next lepak.',steps:['Stand near a player and tap their player action.','Choose Add friend from the menu.','You can also open their profile and add them there.']},
  {id:'clothes',number:'04',signal:'LOOK',title:'Change your clothes',description:'Build a look and see every change on your character instantly.',steps:['Open Character with the hanger at the top right.','Choose Body, Hair, Tops, Bottoms or Tudung.','Tap a style or colour. Your look saves automatically.']},
] as const;
