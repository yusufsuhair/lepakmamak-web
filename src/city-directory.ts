...
const categories:Record<string,string>={kedai:'Shops',bank:'Banks',hotel:'Hotels',civic:'Community',lepak:'Hangouts',gerai:'Food stalls',minyak:'Petrol station',ibadah:'Place of worship',sukan:'Sports'};
