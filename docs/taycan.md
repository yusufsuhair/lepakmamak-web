...
`createDriveableCar('taycan')` provides the standard vehicle interface, four wheel groups, a hidden seated driver and the `VRG9405` plate on both ends. `carStyles` accepts the style for remote players too.
