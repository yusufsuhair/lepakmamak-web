...
const file=fileURLToPath(new URL('../../public/assets/models/environment/LM_ENV_Rembayung.glb',import.meta.url));
...
await fs.writeFile(new URL('../../assets/rembayung/web-compression.json',import.meta.url),JSON.stringify(report,null,2)+'\n');
console.log(report);
