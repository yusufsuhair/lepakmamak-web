...
test('an invite can be answered in the city, and the geng turns the map dot red',async({page})=>{
 ...
 try{
  ...
  // The friend standing at the origin should now be drawn in party red, not peer blue.
