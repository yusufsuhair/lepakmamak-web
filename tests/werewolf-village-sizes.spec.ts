...
import {WEREWOLF_SIZES} from '../server/werewolf.mjs';
...
const PORT='8261';
const bigTable=chairs.filter(c=>c.tableId==='meja-9');
...
test(`a village of ${size} reaches night through the real lobby ritual`,async()=>{
