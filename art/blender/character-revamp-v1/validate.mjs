...
const root=resolve('art/blender/generated/character-revamp-v1');const results=[];
for(const folder of ['exports','references'])for(const file of readdirSync(`${root}/${folder}`).filter(x=>x.endsWith('.glb'))){
