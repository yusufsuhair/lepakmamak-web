...
const input = path.resolve(process.argv[2] ?? path.join(root, 'generated/mamak-maju-v4/exports/LM_ENV_MamakMaju.glb'));
const bytes = await fs.readFile(input);
const reportDir = path.resolve(process.argv[3] ?? path.join(root, 'generated/mamak-maju-v4/reports'));
